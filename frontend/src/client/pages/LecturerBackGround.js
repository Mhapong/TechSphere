        ...
        >
            <div className="bg-white shadow-lg rounded-lg overflow-hidden">
                <div className="p-6 sm:p-8">
                    ...
                    <div className="mt-8">
                        <h3 className="text-lg sm:text-xl font-semibold mb-4 text-gray-800">Created Courses:</h3>
                        {lecturer?.created_courses?.length > 0 ? (
                            ...
                            <p className="text-gray-500 text-sm sm:text-base">No courses created.</p>
                        )}
                    </div>
