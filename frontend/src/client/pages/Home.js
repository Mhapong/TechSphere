...
export default function Home() {
  ...
  const categorys = [
    { name: "พัฒนาเว็ปไซต์", img: webpic, path: "Web Dev" },
    { name: "วิเคราะห์ข้อมูล", img: datapic, path: "Data Analysis" },
    { name: "ฮาร์ดแวร์", img: hardwarepic, path: "Hardware" },
    { name: "สร้างเครือข่าย", img: networkpic, path: "Network" },
    { name: "การพัฒนาเกม", img: gamepic, path: "Game Dev" },
    { name: "ปัญญาประดิษฐ์   ", img: morepic, path: "AI" },
  ];
