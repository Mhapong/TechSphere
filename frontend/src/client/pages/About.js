...
const AboutPage = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-b from-white to-blue-50 dark:from-gray-900 dark:to-gray-800">
      ...
      >
        <p className="italic font-medium text-xl mb-12">
          "TechSphere
          คือองค์กรที่มุ่งเน้นการเสริมสร้างความรู้และทักษะด้านเทคโนโลยีสมัยใหม่
          ผ่านคอร์สเรียนออนไลน์ที่ออกแบบมาเพื่อให้ผู้เรียนสามารถพัฒนาทักษะได้ทุกที่ทุกเวลา
          พร้อมเนื้อหาที่อัปเดตตามเทรนด์เทคโนโลยีล่าสุด
          โดยมีหลักสูตรที่ครอบคลุมตั้งแต่พื้นฐานไปจนถึงระดับสูง
          สอนโดยผู้เชี่ยวชาญในอุตสาหกรรม
          เพื่อให้คุณนำความรู้ไปต่อยอดในการทำงานและสร้างโอกาสใหม่ๆ
          ในสายอาชีพของคุณ"
        </p>
        ...
        <p className="text-xl font-semibold text-blue-600 dark:text-blue-400 mb-6">
          นวัตกรรมที่ล้ำสมัยในการเรียนรู้เทคโนโลยี
        </p>
        <h1 className="text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-purple-600 mb-6">
          Empowering
        </h1>
        <p className="text-xl font-semibold text-blue-600 dark:text-blue-400 mb-6">
          ส่งเสริมและพัฒนาทักษะให้ทุกคนก้าวสู่ยุคดิจิทัล
        </p>
        <h1 className="text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-purple-600 mb-6">
          Future-Ready
        </h1>
        <p className="text-xl font-semibold text-blue-600 dark:text-blue-400 mb-6">
          เตรียมความพร้อมให้คุณรับมือกับอนาคตของเทคโนโลยี
        </p>
      </motion.blockquote>
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-8 max-w-7xl">
          ...
          >
            ...
            <p className="text-blue-800 dark:text-blue-200 max-w-3xl mx-auto text-lg">
              เราพร้อมนำเสนอคอร์สเรียนที่ทันสมัย
              จากเหล่าอาจารย์ผู้มีความเชี่ยวชาญหลากหลายด้านและมีประสบการณ์
              เพื่อช่วยให้ผู้เรียนเข้าใจเนื้อหาได้อย่างลึกซึ้ง
              ผ่านการสอนที่เป็นระบบ และสามารถนำไปประยุกต์ใช้ได้จริง...
            </p>
          </motion.div>
                      ...
                      <img
                        src={`${BASE_URL}${
                          ...
                          lecturer.profile_picture.length > 0
                            ? lecturer.profile_picture[0].formats?.thumbnail
                                ?.url || lecturer.profile_picture[0].url
                            : "/placeholder.svg"
                        }`}
      ...
      <section className="w-full bg-white dark:bg-gray-900 py-16">
        <div className="max-w-screen-xl mx-auto px-4 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400 mb-6">
              เพิ่มพูนทักษะดิจิทัลของคุณ และก้าวสู่อนาคตอย่างมั่นใจ
            </p>
            <a
              href="/explore"
        ...
        {!isAuthenticated && (
          <div className="grid md:grid-cols-2 gap-8 max-w-screen-xl mx-auto px-4 lg:px-8">
            {[
              {
                title: "คุณมีบัญชีแล้ว? กลับมาเรียนกันเถอะ",
                link: "/login",
                btnText: "เข้าสู่ระบบ",
                gradient: "from-blue-500 to-teal-400",
              },
              {
                title: "ยังไม่มีบัญชีใช่ไหม?",
                link: "/sign-up",
                btnText: "ลงทะเบียน",
              ...
              <motion.div
                ...
                transition={{ duration: 0.6 }}
                className="flex flex-col justify-between bg-gradient-to-br from-gray-50 to-white dark:from-gray-800 dark:to-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 min-h-[280px]"
              >
                <div>
                  ...
                  <p className="text-lg text-gray-600 dark:text-gray-400">
                    {index === 0
                      ? "กลับมาพัฒนาทักษะของคุณต่อ และก้าวสู่อนาคตอย่างมั่นใจ! ไม่ว่าคุณจะหยุดไปนานแค่ไหน เรียนรู้ต่อได้ทุกเมื่อที่นี่!"
                      : "เริ่มต้นเส้นทางการเรียนรู้ของคุณวันนี้ แล้วเตรียมพร้อมสำหรับโลกดิจิทัล! ลงทะเบียนตอนนี้เพื่อเปิดประตูสู่โอกาสใหม่ ๆ ที่รอคุณอยู่!"}
                  </p>
                </div>
                <a
                  href={card.link}
                  className={`inline-flex items-center px-6 py-3 rounded-lg bg-gradient-to-r ${card.gradient} hover:bg-blue-700 text-white font-medium transition-colors duration-300`}
                >
                  {card.btnText}
                  <svg
                    className="w-4 h-4 ml-2"
