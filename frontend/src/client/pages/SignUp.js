                    ...
                    <div class="w-full px-8 md:px-32 lg:px-24">
                        <form class="bg-white rounded-md shadow-2xl p-5">
                            ...
                            <div class="flex items-center border-2 mb-5 py-2 px-3 rounded-2xl">
                                <input id="first-name" class=" pl-2 w-full outline-none border-none" type="first-name" name="first-name" placeholder="First Name" />
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <text stroke="grey" font-size="200">|</text>
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
                                </svg>
                                <input id="last-name" class=" pl-2 w-full outline-none border-none" type="last-name" name="last-name" placeholder="Last Name" />
                            </div>
                            <div class="flex items-center border-2 mb-5 py-2 px-3 rounded-2xl">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <div class="flex items-center border-2 mb-5 py-2 px-3 rounded-2xl">
                                ...
                                <input id="username" class=" pl-2 w-full outline-none border-none" type="username" name="username" placeholder="Username" />
                            </div>
                            ...
                            <button type="submit" class="block w-full bg-blue-400 mt-5 py-2 rounded-2xl hover:bg-purple-300 hover:-translate-y-1 transition-all duration-500 text-white font-semibold mb-2">Login</button>
