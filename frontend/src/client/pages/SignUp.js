    ...
    return (
        <div>
            <div class="h-screen flex">
                <div class="hidden lg:flex bg-black w-full lg:w-1/2 login_img_section
                        ...
                        <form class="bg-white rounded-md shadow-2xl p-5 " onSubmit={onSubmit}>
                            ...
                            <div class="flex flex-row items-center border-2 mb-5 py-2 px-3 rounded-2xl">
                                <input
                                    ...
                                    required />
                                <text font-size="200" className="mx-0.5 text-gray-300">|</text>
                            ...
                            <button type="submit" class="block w-full bg-indigo-600 mt-5 py-2 rounded-2xl hover:bg-indigo-700 hover:-translate-y-1 transition-all duration-500 text-white font-semibold mb-2" value="Sign-up">Sign up</button>
