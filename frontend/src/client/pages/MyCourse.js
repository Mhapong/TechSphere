...
const ReviewModal = ({
    ...
    const handleSubmit = async (e) => {
        ...
        const isConfirmed = window.confirm("คุณแน่ใจหรือไม่ว่าต้องการส่งรีวิวนี้? หากยืนยันแล้วจะไม่สามารถแก้ไขได้อีกครั้ง");
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
            <div className="bg-white rounded-lg shadow-md dark:bg-gray-700 p-6 max-w-md w-full relative">
                <button onClick={onClose} className="absolute top-3 right-3 text-gray-400 hover:text-gray-900">
                    ✖
                </button>
                <h3 className="text-lg font-semibold mb-4 text-center">{readOnly ? "Your Review" : "ให้คะแนน & รีวิวคอร์สเรียน"}</h3>
                ...
                ></textarea>
                {!readOnly && (
                    <button onClick={handleSubmit} className="w-full py-2 text-white bg-green-600 rounded-lg hover:bg-green-800">
                        ยืนยันการรีวิว
                    </button>
                )}
            </div>
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
            <div className="bg-white rounded-lg shadow-md dark:bg-gray-700 p-6 max-w-md w-full relative">
                ...
                <h3 className="text-lg font-semibold mb-4 text-center">{readOnly ? "Your Review" : "ให้คะแนน & รีวิวอาจารย์ผู้สอน"}</h3>
                <div className="flex justify-center mb-3">
                    {[1, 2, 3, 4, 5].map((num) => (
                        <button
                            key={num}
...
export default function MyCourse() {
    ...
    return (
        <div className="container mx-auto mt-10 p-5">
            <h1 className="text-4xl font-bold mb-5">ยินดีต้อนรับคุณ, {user ? user.username : "Guest"}</h1>
            ...
            <div className="flex justify-between items-center mb-5 bg-white shadow-md p-3 rounded-lg">
                ...
                />
                <button className="p-2 bg-blue-500 text-white rounded-lg ml-3">ค้นหา</button>
            </div>
                        ...
                        {filteredCourses.map((item) => (
                            ...
                            >
                                ...
                                <div className="mt-4 w-72">
                                    ...
                                    <p className="text-gray-500 text-xs">สิ้นสุด: {item.end_date ? item.end_date : "ไม่ระบุ"}</p>
                                </div>
                    ...
                    >
                        {courseData.map((items) => (
                            ...
                            >
                                ...
                                <div className="mt-4 w-72">
                                    <p className="truncate whitespace-nowrap overflow-hidden">{items.Name}</p>
