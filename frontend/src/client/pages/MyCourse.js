                  ...
                  try {
                    ...
                    setHasReviewedTeacher((prev) => ({
                      ...
                      [String(selectedTeacher.id)]: {
                        ...prev[String(selectedTeacher.id)],
                        rating,
                        comment,
                      },
                    }));
        ...
        {loading ? (
          ...
          <>
            {filteredCourses.length > 0 ? (
                ...
                <div className="flex space-x-6 overflow-x-auto scrollbar-hide px-4 py-2">
                  {filteredCourses.map((item) => (
                    ...
                    >
                      <div
                        onClick={() =>
                          navigate(`/contentstudy/${item.documentId}`)
                        }
                      ...
                      <div className="p-4">
                        ...
                        <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full mt-3">
                          <div
                            ...
                            style={{
                              width: `${progress[item.documentId] || 0}%`,
                            }}
                          >
                            ...
                            {hasReviewedCourses[String(item.id)] ? (
                              <button
                                onClick={() => {
                                  ...
                                  setRating(
                                    hasReviewedCourses[String(item.id)].rating
                                  );
                                  setComment(
              ...
              <p className="text-center text-gray-500 mt-5 dark:text-gray-400">
                ไม่พบคอร์สที่ค้นหา
              </p>
            )}
                ...
                >
                  {courseData && courseData.length === 0 ? (
                    <div className="flex flex-col items-center justify-center h-64">
                      <h1 className="text-3xl font-extrabold text-gray-600 dark:text-gray-400">
                            ...
                            <div className="p-4">
                              ...
                              <div className="flex items-center justify-between mt-2">
                                ...
                                <span className="text-gray-600 dark:text-gray-400">
                                  ขายแล้ว: {course.user_owner?.length || 0}
                                </span>
                              </div>
                            </div>
